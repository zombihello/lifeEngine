    ...
    case wxRICHTEXT_CHANGE_OBJECT:
        {
            ...
            if (obj && m_object && m_ctrl)
            {
                ...
                wxCHECK_MSG((!obj->IsKindOf(wxCLASSINFO(wxRichTextParagraph)) && parent->IsKindOf(wxCLASSINFO(wxRichTextParagraph))) ||
                            (obj->IsKindOf(wxCLASSINFO(wxRichTextParagraph)) && !parent->IsKindOf(wxCLASSINFO(wxRichTextParagraph)))
