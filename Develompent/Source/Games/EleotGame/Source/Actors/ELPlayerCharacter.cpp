...
{
	new( staticClass, TEXT( "Camera Component" ) ) CObjectProperty( TEXT( "Camera" ), TEXT( "Camera component" ), CPP_PROPERTY( cameraComponent ), CPF_Edit, CCameraComponent::StaticClass() );
}
