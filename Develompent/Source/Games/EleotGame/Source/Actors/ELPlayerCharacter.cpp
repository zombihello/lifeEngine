...
{
	new CObjectProperty( staticClass, TEXT( "Camera Component" ), TEXT( "Camera" ), TEXT( "Camera component" ), CPP_PROPERTY( cameraComponent ), CPF_Pointer, CCameraComponent::StaticClass() );
}
