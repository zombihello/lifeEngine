function( EngineBuild MODULE_DIR ALL_SOURCE_FILES INCLUDE_DIRS )
	...
	file( GLOB INCLUDE_COMPONENTS_FILES "${MODULE_DIR}/Include/Components/*.h" )
	file( GLOB INCLUDE_ACTORS_FILES "${MODULE_DIR}/Include/Actors/*.h" )
	file( GLOB INCLUDE_RENDER_VERTEXFACTORY_FILES "${MODULE_DIR}/Include/Render/VertexFactory/*.h" )
	...
	file( GLOB SOURCE_COMPONENTS_FILES "${MODULE_DIR}/Source/Components/*.cpp" )
	file( GLOB SOURCE_ACTORS_FILES "${MODULE_DIR}/Source/Actors/*.cpp" )
	file( GLOB SOURCE_RENDER_VERTEXFACTORY_FILES "${MODULE_DIR}/Source/Render/VertexFactory/*.cpp" )
	...
	set( ALL_SOURCE_FILES ${ALL_SOURCE_FILES}  
		...
		${SOURCE_FILES} ${SOURCE_MISC_FILES} ${SOURCE_RENDER_FILES} ${SOURCE_RENDER_SHADERS_FILES} ${SOURCE_SCRIPTS_FILES} ${SOURCE_SYSTEM_FILES} ${SOURCE_COMPONENTS_FILES} ${SOURCE_ACTORS_FILES} ${SOURCE_RENDER_VERTEXFACTORY_FILES} PARENT_SCOPE )
endfunction()