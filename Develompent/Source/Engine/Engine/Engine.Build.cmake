function( EngineBuild MODULE_DIR ALL_SOURCE_FILES INCLUDE_DIRS )
	...
	set( ALL_SOURCE_FILES ${ALL_SOURCE_FILES}  
		${INCLUDE_FILES} ${INCLUDE_MISC_FILES} ${INCLUDE_RENDER_FILES} ${INCLUDE_RENDER_SHADERS_FILES} ${INCLUDE_RHI_FILES} ${INCLUDE_SCRIPTS_FILES} ${INCLUDE_SYSTEM_FILES} ${INCLUDE_COMPONENTS_FILES} ${INCLUDE_ACTORS_FILES}
		${SOURCE_FILES} ${SOURCE_MISC_FILES} ${SOURCE_RENDER_FILES} ${SOURCE_RENDER_SHADERS_FILES} ${SOURCE_SCRIPTS_FILES} ${SOURCE_SYSTEM_FILES} ${SOURCE_COMPONENTS_FILES} ${SOURCE_ACTORS_FILES} PARENT_SCOPE )
endfunction()