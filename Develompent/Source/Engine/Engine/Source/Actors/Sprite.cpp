...
{
	new CObjectProperty( staticClass, TEXT( "Sprite Component" ), TEXT( "Drawing" ), TEXT( "Sprite component" ), CPP_PROPERTY( spriteComponent ), CPF_Pointer, CSpriteComponent::StaticClass() );
}
