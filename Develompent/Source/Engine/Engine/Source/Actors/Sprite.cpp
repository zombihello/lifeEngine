...
{
	new( staticClass, TEXT( "Sprite Component" ) ) CObjectProperty( TEXT( "Drawing" ), TEXT( "Sprite component" ), CPP_PROPERTY( spriteComponent ), CPF_Edit, CSpriteComponent::StaticClass() );
}
