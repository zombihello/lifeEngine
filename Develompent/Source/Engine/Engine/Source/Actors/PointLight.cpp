...
{
	new( staticClass, TEXT( "Point Light Component" ) ) CObjectProperty( TEXT( "Light" ), TEXT( "Point light component" ), CPP_PROPERTY( pointLightComponent ), CPF_Edit, CPointLightComponent::StaticClass() );
}
