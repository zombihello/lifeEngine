...
{
	new CObjectProperty( staticClass, TEXT( "Point Light Component" ), TEXT( "Light" ), TEXT( "Point light component" ), CPP_PROPERTY( pointLightComponent ), CPF_Pointer, CPointLightComponent::StaticClass() );
}
