...
{
	new( staticClass, TEXT( "Point Light Component" ) ) CObjectProperty( TEXT( "Light" ), TEXT( "Point light component" ), CPP_PROPERTY( pointLightComponent ), 0, CPointLightComponent::StaticClass() );
}
