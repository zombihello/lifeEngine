...
{
	new( staticClass, TEXT( "Directional Light Component" ) ) CObjectProperty( TEXT( "Light" ), TEXT( "Directional light component" ), CPP_PROPERTY( directionalLightComponent ), CPF_Edit, CDirectionalLightComponent::StaticClass() );
}
