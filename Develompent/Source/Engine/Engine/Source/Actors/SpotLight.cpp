...
{
	new( staticClass, TEXT( "Spot Light Component" ) ) CObjectProperty( TEXT( "Light" ), TEXT( "Spot light component" ), CPP_PROPERTY( spotLightComponent ), CPF_Edit, CSpotLightComponent::StaticClass() );
}
