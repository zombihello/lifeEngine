...
struct ObjectResource
{
	...
	CPackageIndex	outerIndex;	/**< Location of the resource for this resource's Outer. Values of 0 indicate that this resource represents a top-level CObjectPackage object (the linker's LinkerRoot). Serialized */
...
struct ObjectExport : public ObjectResource
{
	...
	uint32				hashNext;		/**< The index into the CLinker's ExportMap for the next export in the linker's export hash table. Transient */
};
