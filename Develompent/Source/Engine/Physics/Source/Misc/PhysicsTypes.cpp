...
{
	new( staticStruct, TEXT( "Object Type" ), OBJECT_Public )	CByteProperty( CPP_PROPERTY( ThisStruct, objectType ), NAME_None, TEXT( "Object type" ), CPF_Edit, Enum::ECollisionChannel::StaticEnum() );
	new( staticStruct, TEXT( "Responses" ), OBJECT_Public )		CByteProperty( CPP_PROPERTY( ThisStruct, responses ), NAME_None, TEXT( "Map of responses each collision channel" ), CPF_Edit, Enum::ECollisionResponse::StaticEnum(), CC_Max );
}
