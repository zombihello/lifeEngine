...
#include "UI/Platforms/Windows/WindowsImGUI.h"
...
struct ImGui_ImplSDL2_Data
{
    ...
    ImGui_ImplSDL2_Data()   { Memory::Memset(this, 0, sizeof(*this)); }
};
...
{
    ImGuiIO& io = ImGui::GetIO();
    Memory::Memset(io.NavInputs, 0, sizeof(io.NavInputs));
