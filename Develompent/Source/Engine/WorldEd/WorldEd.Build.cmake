...
set( ALL_CPP_FILES ${SOURCE_FILES} ${SOURCE_RENDER_VERTEXFACTORY_FILES} ${SOURCE_RENDER_SHADERS_FILES} ${SOURCE_RENDER_FILES} ${SOURCE_COMMANDLETS_FILES} ${SOURCE_MISC_FILES} ${SOURCE_SYSTEM_FILES} ${SOURCE_WINDOWS_FILES} )
set( ALL_H_FILES ${INCLUDE_FILES} ${INCLUDE_RENDER_VERTEXFACTORY_FILES} ${INCLUDE_RENDER_SHADERS_FILES} ${INCLUDE_RENDER_FILES} ${INCLUDE_COMMANDLETS_FILES} ${INCLUDE_MISC_FILES} ${INCLUDE_SYSTEM_FILES} ${INCLUDE_WINDOWS_FILES} )
