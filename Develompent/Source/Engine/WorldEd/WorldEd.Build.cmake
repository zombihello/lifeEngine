...
file( GLOB FORMS_DIALOGS_FILES "${PROJECT_WORLDED}/Source/Dialogs/*.ui" )
...
set( ALL_UI_FILES ${FORMS_DIALOGS_FILES} ${FORMS_WINDOWS_FILES} ${FORMS_WIDGETS_FILES} )
...
source_group( "Engine/WorldEd/Forms/Dialogs" FILES ${FORMS_DIALOGS_FILES} )
