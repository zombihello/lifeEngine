...
/*
==================
CScriptSyntaxNode_StringConst::AcceptVisitor
==================
*/
void CScriptSyntaxNode_StringConst::AcceptVisitor( CScriptSyntaxVisitor& InVisitor )
{
	InVisitor.VisitSyntaxNode_StringConst( this );
}