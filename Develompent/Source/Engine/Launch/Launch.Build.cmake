...
# *.RC
file( GLOB RC_FILES "${PROJECT_LAUNCH}/Resources/*.rc" )
...
source_group( "Engine/Launch/Resources" FILES ${RC_FILES} )
...
set( ALL_SOURCE_FILES ${ALL_SOURCE_FILES} 
	${INCLUDE_FILES} ${INCLUDE_MISC_FILES} ${SOURCE_FILES} ${RC_FILES} )